    ...
    return (
        <div className="">
            <div className="w-full bg-[#1E212C] flex justify-center">
                <div className="w-[95%] sm:w-[95%] md:w-[92%] lg:w-[80%] flex justify-between text-white leading-[21px] font-[400] text-[12px] md:text-[14px] py-1">
            ...
            <div className="w-full bg-white flex justify-center gap-3 ">
                <div className="w-[95%] sm:w-[95%] md:w-[92%] lg:w-[80%] flex justify-between items-center text-[#424551] leading-[26px] font-[700] text-[12px] md:text-[14px] py-5">
                    ...
                    <div className="flex md:gap-2 gap-1 items-center">
                        ...
                        <div className="border-l border-gray-300 h-5"></div> {/* Border */}
                        ...
                        <div className="border-l border-gray-300 h-5 md:hidden"></div> {/* Border */}
